...
L8831:
        ...
        adc     L87CD,y                         ; 884E 79 CD 87                 y..
        jmp     L888B                           ; 8851 4C 8B 88                 L..
...
L88A8:
        ...
        ldx     #$FF                            ; 88CB A2 FF                    ..
        jmp     L88DD                           ; 88CD 4C DD 88                 L..

; ----------------------------------------------------------------------------
L88D0:
        ldx     $0614                           ; 88D0 AE 14 06                 ...
        bmi     L88D9                           ; 88D3 30 04                    0.
        dex                                     ; 88D5 CA                       .
        jmp     L88DD                           ; 88D6 4C DD 88                 L..
...
L8968:
        .byte   $2C,$5B,$5D,$2C,$2C,$2C,$71,$72 ; 8968 2C 5B 5D 2C 2C 2C 71 72  ,[],,,qr
        .byte   $2C,$2C,$2C,$57,$59,$2C,$2C     ; 8970 2C 2C 2C 57 59 2C 2C     ,,,WY,,
; ----------------------------------------------------------------------------
L8977:
        ldy     debugHiddenMusic                ; 8977 AC 04 C0                 ...
        bne     L89AC                           ; 897A D0 30                    .0
        sta     $2A                             ; 897C 85 2A                    .*
...
; ----------------------------------------------------------------------------
L89AD:
        .byte   $2C,$2C,$58,$2E,$72,$5E,$2C,$2C ; 89AD 2C 2C 58 2E 72 5E 2C 2C  ,,X.r^,,
        .byte   $2C,$2C,$2C,$5B,$5A,$72,$5B,$59 ; 89B5 2C 2C 2C 5B 5A 72 5B 59  ,,,[Zr[Y
        .byte   $2C,$2C,$2C,$2C,$5F,$5F,$72,$5C ; 89BD 2C 2C 2C 2C 5F 5F 72 5C  ,,,,__r\
        .byte   $2C,$2C,$2C,$2C,$2C,$5B,$71,$5F ; 89C5 2C 2C 2C 2C 2C 5B 71 5F  ,,,,,[q_
...
L9071:
        ...
        lda     $48                             ; 9075 A5 48                    .H
        clc                                     ; 9077 18                       .
        adc     $46                             ; 9078 65 46                    eF
        sta     $48                             ; 907A 85 48                    .H
        lda     $49                             ; 907C A5 49                    .I
        adc     $47                             ; 907E 65 47                    eG
        sta     $49                             ; 9080 85 49                    .I
L9082:
        asl     $46                             ; 9082 06 46                    .F
        rol     $47                             ; 9084 26 47                    &G
...
; ----------------------------------------------------------------------------
L93DB:
        .byte   $5F,$8B,$0E,$7C,$1F,$A9,$2E,$3B ; 93DB 5F 8B 0E 7C 1F A9 2E 3B  _..|...;
        .byte   $DF,$A3,$9E,$B8,$9F,$A9,$2E,$6F ; 93E3 DF A3 9E B8 9F A9 2E 6F  .......o
        .byte   $9F,$81,$1E,$58,$DF,$19,$FE,$48 ; 93EB 9F 81 1E 58 DF 19 FE 48  ...X...H
        .byte   $DF,$2A,$01,$8E,$9F,$F9,$1E,$57 ; 93F3 DF 2A 01 8E 9F F9 1E 57  .*.....W
        .byte   $9F,$F9,$D2,$52,$43,$00,$60,$3B ; 93FB 9F F9 D2 52 43 00 60 3B  ...RC.`;
        .byte   $9F,$8C,$80,$F9,$00,$00,$00,$00 ; 9403 9F 8C 80 F9 00 00 00 00  ........
; ----------------------------------------------------------------------------
L940B:
        pha                                     ; 940B 48                       H
        lda     #$30                            ; 940C A9 30                    .0
        ldx     $0570                           ; 940E AE 70 05                 .p.
        ldy     $0571                           ; 9411 AC 71 05                 .q.
...
L94C5:
        inc     $1D                             ; 94C5 E6 1D                    ..
        dec     $1C                             ; 94C7 C6 1C                    ..
        dec     $0570                           ; 94C9 CE 70 05                 .p.
        jmp     L94A9                           ; 94CC 4C A9 94                 L..

; ----------------------------------------------------------------------------
L94CF:
        inc     $1C                             ; 94CF E6 1C                    ..
        inc     $0570                           ; 94D1 EE 70 05                 .p.
        dec     $1D                             ; 94D4 C6 1D                    ..
...
L95E5:
        .byte   $01,$04,$0A,$1E,$78             ; 95E5 01 04 0A 1E 78           ....x
L95EA:
...
L9A64:
        ...
        lda     unknownTable09+1,x              ; 9A74 BD 61 9A                 .a.
...
L9AA6:
        ...
        jsr     sleepRoutine                    ; 9ACE 20 31 9B                  1.
...
unknownTable04:
        ...
        .byte   $32,$00,$08,$33,$08,$08,$80     ; 9BC5 32 00 08 33 08 08 80     2..3...
L9BCC:
        .byte   $50,$90,$50,$40,$8D,$9B,$14,$01 ; 9BCC 50 90 50 40 8D 9B 14 01  P.P@....
...
L9C11:
        .byte   $A5,$61,$A5,$61,$B2,$9B,$64,$01 ; 9C11 A5 61 A5 61 B2 9B 64 01  .a.a..d.
...
LC102:
        ...
        .addr   LC175                           ; C106 75 C1                    u.
        .addr   LC123                           ; C108 23 C1                    #.
        .addr   LC149                           ; C10A 49 C1                    I.
        .addr   LC135                           ; C10C 35 C1                    5.
...
LE9C3:
        ...
        .byte   $32,$31,$30,$2F,$2E,$2D,$2C,$00 ; E9FB 32 31 30 2F 2E 2D 2C 00  210/.-,.
...
; ----------------------------------------------------------------------------
LEAE5:
        .byte   $0F,$10,$20,$30,$0F,$00,$10,$20 ; EAE5 0F 10 20 30 0F 00 10 20  .. 0... 
        .byte   $0F,$0F,$00,$10,$0F,$0F,$0F,$00 ; EAED 0F 0F 00 10 0F 0F 0F 00  ........
; ----------------------------------------------------------------------------
LEAF5:
        jsr     LFF00                           ; EAF5 20 00 FF                  ..
        lda     rngSeed+4                       ; EAF8 A5 5A                    .Z
        and     $A9                             ; EAFA 25 A9                    %.
...
; ----------------------------------------------------------------------------
        ...
        .byte   $00,$00,$00,$00,$00,$00,$61,$B8 ; EDFA 00 00 00 00 00 00 61 B8  ......a.
        .byte   $FB,$EE,$FF,$FF,$FF,$FF,$1D,$CD ; EE02 FB EE FF FF FF FF 1D CD  ........
        .byte   $B4,$F7,$F7,$FF,$FF,$FF,$A5,$31 ; EE0A B4 F7 F7 FF FF FF A5 31  .......1
        .byte   $A4,$EF,$FF,$FF,$FF,$FF,$0D,$45 ; EE12 A4 EF FF FF FF FF 0D 45  .......E
        .byte   $A6,$FF,$FF,$FF,$FF,$FF,$4A,$09 ; EE1A A6 FF FF FF FF FF 4A 09  ......J.
        .byte   $FF,$FF,$FD,$FE,$FF,$FF,$A0,$E9 ; EE22 FF FF FD FE FF FF A0 E9  ........
        .byte   $ED,$F3,$FF,$DF,$FF,$FF,$53,$05 ; EE2A ED F3 FF DF FF FF 53 05  ......S.
        .byte   $EB,$EE,$FF,$FF,$FF,$F6,$4E,$6B ; EE32 EB EE FF FF FF F6 4E 6B  ......Nk
        .byte   $BD,$F6,$FF,$FF,$FF,$FF,$7B,$0A ; EE3A BD F6 FF FF FF FF 7B 0A  ......{.
        .byte   $AA,$BB,$FF,$FF,$FF,$BF,$E7,$59 ; EE42 AA BB FF FF FF BF E7 59  .......Y
        .byte   $FD,$FE,$FF,$FF,$FF,$FF,$53,$6C ; EE4A FD FE FF FF FF FF 53 6C  ......Sl
        .byte   $FF,$37,$FF,$FF,$FF,$FF,$6F,$32 ; EE52 FF 37 FF FF FF FF 6F 32  .7....o2
        .byte   $E9,$F9,$7F,$FF,$FF,$FF,$2E,$54 ; EE5A E9 F9 7F FF FF FF 2E 54  .......T
        .byte   $FD,$BB,$FF,$FF,$FF,$FF,$38,$B3 ; EE62 FD BB FF FF FF FF 38 B3  ......8.
        .byte   $BA,$F2,$FF,$FE,$EF,$FF,$25,$83 ; EE6A BA F2 FF FE EF FF 25 83  ......%.
        .byte   $E1,$8F,$FF,$FF,$DF,$FF,$CA,$19 ; EE72 E1 8F FF FF DF FF CA 19  ........
        .byte   $FF,$FF,$FF,$F7,$FF,$FF,$38,$FD ; EE7A FF FF FF F7 FF FF 38 FD  ......8.
        .byte   $F2,$99,$FF,$FF,$6F,$FF,$66,$B5 ; EE82 F2 99 FF FF 6F FF 66 B5  ....o.f.
        .byte   $5F,$BF,$FF,$FF,$FF,$FE,$CA,$E2 ; EE8A 5F BF FF FF FF FE CA E2  _.......
        .byte   $FE,$DF,$FF,$FF,$FF,$FF,$48,$A7 ; EE92 FE DF FF FF FF FF 48 A7  ......H.
        .byte   $EF,$DF,$FF,$FF,$FF,$FF,$82,$74 ; EE9A EF DF FF FF FF FF 82 74  .......t
        .byte   $F5,$D7,$FF,$FF,$FF,$DB,$A1,$4E ; EEA2 F5 D7 FF FF FF DB A1 4E  .......N
        .byte   $F3,$C5,$FF,$FF,$FF,$BF,$3E,$D0 ; EEAA F3 C5 FF FF FF BF 3E D0  ......>.
        .byte   $FE,$3F,$FF,$FF,$FF,$FF,$BE,$6E ; EEB2 FE 3F FF FF FF FF BE 6E  .?.....n
        .byte   $F7,$FE,$FF,$FF,$FF,$FF,$11,$A3 ; EEBA F7 FE FF FF FF FF 11 A3  ........
        .byte   $E3,$EB,$FF,$FF,$F7,$FF,$36,$C8 ; EEC2 E3 EB FF FF F7 FF 36 C8  ......6.
        .byte   $DE,$B9,$FF,$FF,$FF,$FF,$85,$DB ; EECA DE B9 FF FF FF FF 85 DB  ........
        .byte   $EB,$F9,$FF,$FF,$FF,$FF,$18,$8F ; EED2 EB F9 FF FF FF FF 18 8F  ........
        .byte   $EB,$FE,$FF,$FF,$BF,$FF,$46,$2C ; EEDA EB FE FF FF BF FF 46 2C  ......F,
        ...
        .byte   $00,$00,$44,$00,$00,$00,$00,$00 ; EF12 00 00 44 00 00 00 00 00  ..D.....
        ...
        .byte   $CC,$1B,$C0,$4B,$C2,$CC,$CC,$C8 ; F0FA CC 1B C0 4B C2 CC CC C8  ...K....
        .byte   $AC,$CA,$CC,$6B,$C2,$CC,$CC,$CC ; F102 AC CA CC 6B C2 CC CC CC  ...k....
        .byte   $CC,$88,$8C,$1B,$A4,$AA,$C8,$88 ; F10A CC 88 8C 1B A4 AA C8 88  ........
        .byte   $AC,$BA,$44,$AC,$CC,$C9,$0B,$A0 ; F112 AC BA 44 AC CC C9 0B A0  ..D.....
        .byte   $AA,$CA,$C9,$BC,$61,$8C,$A8,$CA ; F11A AA CA C9 BC 61 8C A8 CA  ....a...
        .byte   $AA,$CA,$6B,$C0,$CC,$8C,$8C,$A8 ; F122 AA CA 6B C0 CC 8C 8C A8  ..k.....
        ...
        .byte   $05,$CC,$98,$9C,$C9,$6B,$C2,$8C ; F14A 05 CC 98 9C C9 6B C2 8C  .....k..
        .byte   $C8,$0B,$A6,$AA,$AC,$1B,$C6,$8C ; F152 C8 0B A6 AA AC 1B C6 8C  ........
        .byte   $88,$9C,$BC,$03,$8C,$CC,$3B,$C2 ; F15A 88 9C BC 03 8C CC 3B C2  ......;.
        .byte   $CC,$C8,$AA,$CC,$4B,$C4,$C9,$99 ; F162 CC C8 AA CC 4B C4 C9 99  ....K...
        .byte   $BC,$61,$8C,$C8,$C8,$CA,$3B,$A6 ; F16A BC 61 8C C8 C8 CA 3B A6  .a....;.
        ...
        .byte   $60,$CA,$BC,$46,$CC,$8C,$98,$C9 ; F18A 60 CA BC 46 CC 8C 98 C9  `..F....
        .byte   $C9,$6B,$C4,$88,$C8,$C9,$CC,$CC ; F192 C9 6B C4 88 C8 C9 CC CC  .k......
        .byte   $BC,$64,$8C,$9C,$CC,$CC,$3B,$C4 ; F19A BC 64 8C 9C CC CC 3B C4  .d....;.
        .byte   $A8,$AA,$CC,$4B,$C2,$CC,$C9,$99 ; F1A2 A8 AA CC 4B C2 CC C9 99  ...K....
        .byte   $C9,$CC,$6D,$A2,$CA,$CC,$8C,$CC ; F1AA C9 CC 6D A2 CA CC 8C CC  ..m.....
        ...
        .byte   $CC,$5B,$A6,$AC,$CA,$CC,$BC,$41 ; F1CA CC 5B A6 AC CA CC BC 41  .[.....A
        .byte   $CC,$8C,$88,$AC,$AA,$BC,$63,$AA ; F1D2 CC 8C 88 AC AA BC 63 AA  ......c.
        .byte   $CA,$CC,$3B,$C4,$CC,$CC,$A8,$CA ; F1DA CA CC 3B C4 CC CC A8 CA  ..;.....
        .byte   $CA,$1B,$C6,$8C,$C8,$A8,$CA,$CC ; F1E2 CA 1B C6 8C C8 A8 CA CC  ........
        .byte   $3B,$C2,$AA,$AC,$BC,$43,$AA,$C8 ; F1EA 3B C2 AA AC BC 43 AA C8  ;....C..
        .byte   $CA,$CC,$0B,$A0,$CA,$BC,$20,$AA ; F1F2 CA CC 0B A0 CA BC 20 AA  ...... .
        .byte   $CC,$CC,$2B,$C6,$99,$9C,$C9,$CC ; F1FA CC CC 2B C6 99 9C C9 CC  ..+.....
        .byte   $BC,$44,$8C,$C9,$C9,$BC,$06,$CC ; F202 BC 44 8C C9 C9 BC 06 CC  .D......
        .byte   $C8,$98,$C9,$CC,$4B,$96,$99,$9C ; F20A C8 98 C9 CC 4B 96 99 9C  ....K...
        .byte   $BC,$02,$CC,$A8,$AC,$CA,$CC,$DC ; F212 BC 02 CC A8 AC CA CC DC  ........
        .byte   $21,$CC,$CC,$AA,$AA,$CA,$BC,$22 ; F21A 21 CC CC AA AA CA BC 22  !......"
        .byte   $8C,$C8,$AA,$CC,$6B,$C6,$C8,$C9 ; F222 8C C8 AA CC 6B C6 C8 C9  ....k...
        .byte   $BC,$65,$99,$99,$CC,$2B,$C0,$C8 ; F22A BC 65 99 99 CC 2B C0 C8  .e...+..
        .byte   $CC,$CA,$CC,$CC,$9C,$C9,$BC,$03 ; F232 CC CA CC CC 9C C9 BC 03  ........
        .byte   $CC,$8C,$AC,$AA,$CC,$2B,$A2,$CC ; F23A CC 8C AC AA CC 2B A2 CC  .....+..
        .byte   $CC,$CC,$CC,$CC,$4B,$C4,$CC,$8C ; F242 CC CC CC CC 4B C4 CC 8C  ....K...
        .byte   $99,$9C,$99,$BC,$05,$CC,$8C,$9C ; F24A 99 9C 99 BC 05 CC 8C 9C  ........
        .byte   $99,$CC,$CC,$CC,$CC,$AC,$AA,$CC ; F252 99 CC CC CC CC AC AA CC  ........
        .byte   $BC,$65,$CA,$CC,$0B,$94,$99,$CC ; F25A BC 65 CA CC 0B 94 99 CC  .e......
        .byte   $BC,$45,$CC,$CC,$CC,$C8,$99,$9C ; F262 BC 45 CC CC CC C8 99 9C  .E......
        .byte   $BC,$21,$8C,$C8,$CC,$9C,$C9,$CC ; F26A BC 21 8C C8 CC 9C C9 CC  .!......
        .byte   $AA,$CA,$AA,$3D,$94,$C9,$3B,$C6 ; F272 AA CA AA 3D 94 C9 3B C6  ...=..;.
        .byte   $CC,$AC,$AA,$CC,$4B,$C4,$C8,$99 ; F27A CC AC AA CC 4B C4 C8 99  ....K...
        .byte   $C9,$4B,$C4,$C8,$C9,$6B,$C2,$C8 ; F282 C9 4B C4 C8 C9 6B C2 C8  .K...k..
        .byte   $98,$C9,$BC,$46,$CA,$CA,$CC,$BC ; F28A 98 C9 BC 46 CA CA CC BC  ...F....
        .byte   $62,$C8,$88,$C9,$BC,$64,$99,$99 ; F292 62 C8 88 C9 BC 64 99 99  b....d..
        ...
        .byte   $00,$00,$00,$00,$00,$00,$00,$33 ; F472 00 00 00 00 00 00 00 33  .......3
        .byte   $00,$34,$00,$00,$35,$36,$00,$00 ; F47A 00 34 00 00 35 36 00 00  .4..56..
        .byte   $00,$37,$38,$38,$34,$00,$00,$00 ; F482 00 37 38 38 34 00 00 00  .7884...
        .byte   $00,$00,$00,$00,$00,$33,$33,$00 ; F48A 00 00 00 00 00 33 33 00  .....33.
        .byte   $36,$35,$00,$00,$00,$33,$37,$38 ; F492 36 35 00 00 00 33 37 38  65...378
        .byte   $00,$00,$38,$38,$34,$00,$00,$00 ; F49A 00 00 38 38 34 00 00 00  ..884...
        .byte   $00,$35,$00,$00,$00,$36,$00,$00 ; F4A2 00 35 00 00 00 36 00 00  .5...6..
        .byte   $00,$00,$35,$33,$37,$37,$00,$00 ; F4AA 00 00 35 33 37 37 00 00  ..5377..
        .byte   $38,$35,$33,$36,$00,$34,$34,$35 ; F4B2 38 35 33 36 00 34 34 35  8536.445
        .byte   $00,$00,$00,$37,$37,$00,$35,$35 ; F4BA 00 00 00 37 37 00 35 35  ...77.55
        .byte   $34,$00,$00,$00,$00,$00,$00,$46 ; F4C2 34 00 00 00 00 00 00 46  4......F
        .byte   $CC,$8C,$99,$C9,$BC,$62,$88,$AC ; F4CA CC 8C 99 C9 BC 62 88 AC  .....b..
        ...
        .byte   $9C,$C9,$6B,$82,$8C,$AA,$CA,$0B ; F4EA 9C C9 6B 82 8C AA CA 0B  ..k.....
        .byte   $A4,$CA,$BC,$60,$99,$C9,$5B,$80 ; F4F2 A4 CA BC 60 99 C9 5B 80  ...`..[.
        .byte   $AA,$AA,$AC,$1B,$C4,$88,$A8,$AA ; F4FA AA AA AC 1B C4 88 A8 AA  ........
        .byte   $CA,$BA,$41,$BC,$23,$CC,$99,$C9 ; F502 CA BA 41 BC 23 CC 99 C9  ..A.#...
        ...
        .byte   $C6,$8C,$99,$99,$BC,$43,$CC,$8C ; F522 C6 8C 99 99 BC 43 CC 8C  .....C..
        .byte   $C9,$1B,$80,$C9,$3B,$C0,$C8,$B9 ; F52A C9 1B 80 C9 3B C0 C8 B9  ....;...
        .byte   $42,$CC,$88,$A8,$AA,$CC,$6B,$90 ; F532 42 CC 88 A8 AA CC 6B 90  B.....k.
        .byte   $99,$C9,$BC,$62,$AA,$BC,$04,$9C ; F53A 99 C9 BC 62 AA BC 04 9C  ...b....
        .byte   $99,$9C,$BC,$26,$CC,$AA,$BC,$24 ; F542 99 9C BC 26 CC AA BC 24  ...&...$
        .byte   $99,$BC,$43,$CC,$C8,$99,$9C,$C9 ; F54A 99 BC 43 CC C8 99 9C C9  ..C.....
        .byte   $5B,$C6,$9C,$99,$C9,$2B,$A0,$AC ; F552 5B C6 9C 99 C9 2B A0 AC  [....+..
        .byte   $CA,$A8,$BA,$62,$AA,$AA,$5B,$A2 ; F55A CA A8 BA 62 AA AA 5B A2  ...b..[.
        .byte   $CC,$AA,$CA,$BA,$24,$AA,$CA,$C9 ; F562 CC AA CA BA 24 AA CA C9  ....$...
        .byte   $BC,$02,$CC,$88,$A8,$AC,$AA,$4B ; F56A BC 02 CC 88 A8 AC AA 4B  .......K
        .byte   $80,$BC,$45,$8C,$9C,$CC,$4B,$C0 ; F572 80 BC 45 8C 9C CC 4B C0  ..E...K.
        .byte   $CC,$C8,$CC,$BC,$06,$88,$9C,$C9 ; F57A CC C8 CC BC 06 88 9C C9  ........
        .byte   $3B,$92,$99,$99,$CC,$3B,$92,$99 ; F582 3B 92 99 99 CC 3B 92 99  ;....;..
        .byte   $B9,$02,$8C,$88,$BC,$61,$8C,$CC ; F58A B9 02 8C 88 BC 61 8C CC  .....a..
        .byte   $A8,$AC,$BA,$42,$8C,$88,$88,$8C ; F592 A8 AC BA 42 8C 88 88 8C  ...B....
        .byte   $6B,$86,$88,$AC,$AA,$6B,$C4,$88 ; F59A 6B 86 88 AC AA 6B C4 88  k....k..
        ...
        .byte   $3B,$C4,$C8,$3B,$B6,$66,$98,$CC ; F5BA 3B C4 C8 3B B6 66 98 CC  ;..;.f..
        .byte   $BC,$00,$AA,$AC,$CC,$8C,$3B,$92 ; F5C2 BC 00 AA AC CC 8C 3B 92  ......;.
        .byte   $C9,$5B,$A6,$AA,$AA,$BC,$62,$AC ; F5CA C9 5B A6 AA AA BC 62 AC  .[....b.
        .byte   $AC,$AA,$8C,$C8,$CC,$4B,$84,$99 ; F5D2 AC AA 8C C8 CC 4B 84 99  .....K..
        .byte   $C9,$B9,$42,$8C,$AC,$AA,$4B,$80 ; F5DA C9 B9 42 8C AC AA 4B 80  ..B...K.
        .byte   $9C,$99,$99,$BC,$41,$8C,$88,$CA ; F5E2 9C 99 99 BC 41 8C 88 CA  ....A...
        .byte   $AA,$AA,$4B,$C4,$98,$99,$99,$BC ; F5EA AA AA 4B C4 98 99 99 BC  ..K.....
        .byte   $26,$88,$8C,$99,$BC,$23,$A8,$AC ; F5F2 26 88 8C 99 BC 23 A8 AC  &....#..
        .byte   $6B,$90,$C9,$99,$0B,$A6,$CC,$0B ; F5FA 6B 90 C9 99 0B A6 CC 0B  k.......
        .byte   $A6,$CC,$BC,$61,$88,$BC,$FF,$FF ; F602 A6 CC BC 61 88 BC FF FF  ...a....
